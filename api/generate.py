@ -2,15 +2,68 @@ from http.server import BaseHTTPRequestHandler
import json
import os
import requests
import base64
...
@ -32,12 +85,53 @@ class handler(BaseHTTPRequestHandler):
        ...
        try:
@ -69,4 +163,43 @@ class handler(BaseHTTPRequestHandler):
            self.end_headers()
